...
participant get_participant() {
  ...
  printf("Katilimcinin adini girin: ");
  scanf("%s", participant.name);

  printf("Katilimcinin teklifini girin: ");
...
int main() {
  ...
  printf("Acik artirmaya katilacak katilimci sayisini girin: ");
  scanf("%d", &participant_count);

  // Açık artırmaya katılacak katılımcıları tutan bir dizi 
